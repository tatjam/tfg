...
{
	Vector3d center = effect.vertices.col(effect.quads(0, effect_panel)).matrix();
	center += effect.vertices.col(effect.quads(1, effect_panel)).matrix();
	center += effect.vertices.col(effect.quads(2, effect_panel)).matrix();
	center += effect.vertices.col(effect.quads(3, effect_panel)).matrix();
	center /= 4.0;
